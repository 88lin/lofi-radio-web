...
> ⚠️ **注意**: Cloudflare Pages 部署 Next.js 需要使用 `@cloudflare/next-on-pages` 适配器。部分 Next.js 功能（如 Middleware、ISR）可能不完全支持。详见 [Cloudflare Next.js 指南](https://developers.cloudflare.com/pages/framework-guides/nextjs)。
