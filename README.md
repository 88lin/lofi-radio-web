...
```bash
# 克隆仓库
git clone https://github.com/labilio/lofi-radio-web.git
cd lofi-radio-web
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/labilio/lofi-radio-web)
...
- [提交 Issue](https://github.com/labilio/lofi-radio-web/issues)
- [参与讨论](https://github.com/labilio/lofi-radio-web/discussions)

## 👥 作者

本项目由 [茉灵智库](https://github.com/labilio) 开发维护。

原项目 [labilio/lofi-radio](https://github.com/labilio/lofi-radio) 提供了优秀的桌面版实现和电台资源。
